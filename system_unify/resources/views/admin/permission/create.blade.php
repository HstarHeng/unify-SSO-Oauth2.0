...
@section('content')
    <article class="page-container">
        ...
        <form action="{{route('admin.permission.store')}}" method="post" class="form form-horizontal" id="form-member-add">
            @csrf
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" style="width: 380px" name="redirect_uri"
                           placeholder="http://xxxx或http://xxxx" autocomplete="off">
                </div>
            </div>
            <div class="row cl">
