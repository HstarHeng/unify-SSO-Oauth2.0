...
@section('content')
    <article class="page-container">
        ...
        <form action="{{route('admin.permission.update', ['id' => $model->id])}}" method="post" class="form form-horizontal" id="form-member-add">
            @csrf
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" style="width: 380px" name="redirect_uri" value="{{$model->redirect_uri}}">
                </div>
            </div>
            <div class="row cl">
        ...
        $("#form-member-add").validate({
            ...
            submitHandler:function(form){
                $(form).ajaxSubmit({
                    type:'post',
                    dataType:'json',
                    url:"{{route('admin.permission.update', ['id' => $model->id])}}",
